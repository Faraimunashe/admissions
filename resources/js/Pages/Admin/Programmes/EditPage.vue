<template>
    <div class="max-w-2xl mx-auto">
        ...
        <div class="mb-8">
            ...
            <h1 class="text-3xl font-bold text-gray-900">Edit Programme</h1>
            <p class="text-gray-600 mt-2">Update programme information</p>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-8 py-6 border-b border-gray-200">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600 mt-1">Update the programme details below</p>
                    </div>
                </div>
            </div>
            ...
            <form @submit.prevent="submit" class="p-8">
                ...
                <div class="flex items-center justify-end space-x-4 pt-8 border-t border-gray-200 mt-8">
                    ...
                    >
                        <span v-if="!form.processing">Update Programme</span>
        ...
        <div v-if="form.wasSuccessful" class="mt-6 bg-green-50 border border-green-200 rounded-xl p-4">
            <div class="flex items-center">
                ...
                <span class="text-green-800 text-sm font-medium">Programme updated successfully</span>
            </div>
        </div>
    </div>
</template>
...
const submit = () => {
    form.put(`/admin/programmes/${props.programme.id}`)
}
</script>
