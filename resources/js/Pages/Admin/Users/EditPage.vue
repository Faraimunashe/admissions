...
export default {
    ...
    setup(props) {
        const form = useForm({
            ...
            institute_id: props.user.institutes?.[0]?.id || '',
            // Applicant fields
            title: props.user.applicant?.title || '',
            firstnames: props.user.applicant?.firstnames || '',
            surname: props.user.applicant?.surname || '',
            gender: props.user.applicant?.gender || '',
            phone: props.user.applicant?.phone || '',
            address: props.user.applicant?.address || '',
            dob: props.user.applicant?.dob || '',
        });
