    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900">Edit Institute</h1>
                    <p class="mt-2 text-gray-600">Update institute information and settings</p>
                </div>
                <Link
                        ...
                        <div class="flex items-center justify-center w-full">
                            <label for="logo" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 hover:bg-gray-100 transition-colors duration-200">
                                <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                    <svg v-if="!previewImage && !currentLogo" class="w-8 h-8 mb-4 text-gray-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
                                    </svg>
                                    <img v-else-if="previewImage" :src="previewImage" alt="Logo preview" class="w-32 h-32 object-cover rounded-lg mb-4">
                                    <img v-else-if="currentLogo" :src="`/storage/${currentLogo}`" alt="Current logo" class="w-32 h-32 object-cover rounded-lg mb-4">
                                    <p v-if="!previewImage && !currentLogo" class="mb-2 text-sm text-gray-500">
                ...
                <div class="bg-gray-50 px-8 py-6 border-t border-gray-200">
                    <div class="flex justify-end space-x-4">
                        ...
                        >
                            ...
                            {{ form.processing ? 'Updating Institute...' : 'Update Institute' }}
                        </button>
                    </div>
                </div>
            </form>
...
export default {
    ...
    setup(props) {
        const form = useForm({
            ...
            phone: props.institute.phone || '',
            address: props.institute.address || '',
            web: props.institute.web || '',
            logo: null,
        });

        const previewImage = ref(null);
        const currentLogo = ref(props.institute.logo);
        ...
        const submit = () => {
            form.put(`/admin/institutes/${props.institute.id}`);
        };
